# personas.py
# Extractor personas for web development datagen.
# Each persona is a dict with:
#   - name:    short label for logging
#   - system:  the system prompt (use {subtopic} placeholder)
#   - temperature: suggested sampling temp (more creative personas = higher)
...
# ================================================================
# GENERATOR PERSONAS  (the "assistant" being trained)
# ================================================================
GENERATOR_PERSONAS = [
    {
